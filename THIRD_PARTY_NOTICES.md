# Third-party and cross-repository notices

This file will record code and content incorporated into Narramorph beyond ordinary package-manager dependencies.

## Consolidation references

Narramorph's consolidation program studies behavior and design from:

- `zekusmaximus/Project-Leibniz`, tagged `pre-consolidation-2026-07-13`;
- `zekusmaximus/eternal-return-digital-self`, tagged `pre-consolidation-2026-07-13`;
- `zekusmaximus/Eternal_Return_Manuscript`, tagged `pre-consolidation-2026-07-13`.
