---
variationId: arch-L2-resist-FR-15
...
generationHints:
  keyPhrases:
    - >-
      Legal division required authentication certification for Fragment
      4429-F—consciousness preservation subject to inheritance dispute.
    - >-
      Deceased's family contested digital consciousness counted as consciousness
      for inheritance purposes.
    - >-
      Legal framework demanded professional archaeologist certification:
      consciousness preserved or sophisticated memorial simulation?
    - >-
      Standard authentication protocol applied to questions authentication
      methodology couldn't resolve.
    - Third legal authentication this month.
    - >-
      Three cases where consciousness definition mattered legally, remained
      unprovable scientifically.
    - The authentication station hummed its steady frequency.
    - >-
      Standard tier access: preserved consciousness examination authorized,
      three-hour session window, certification documentation required.
    - >-
      Professional obligation to legal system despite philosophical
      impossibility of definitive consciousness proof.
    - >-
      She designed Test 1 knowing legal certification required binary
      answer—consciousness present or absent—that philosophical investigation
      revealed as false binary.
