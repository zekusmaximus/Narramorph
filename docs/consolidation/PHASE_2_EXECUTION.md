...
- Stable opaque IDs, canonical JSON, SHA-256 content hashing, explicit timestamp exclusion, schema/app compatibility, and saved-journey package identity will be made executable in Batch 2.2.
