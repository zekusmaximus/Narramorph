...
export function validateWordCount(
  ...
  if (percentDiff > tolerance) {
    logger.warning('WORD_COUNT_DRIFT',
...
export function validateVariationCount(
  ...
  if (actualCount !== expectedCount) {
    ...
    logger.log('COUNT_MISMATCH', severity as any,
